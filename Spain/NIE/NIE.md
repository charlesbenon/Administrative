...
As UE citizen and working in Spain, that what you will need if you are based in Madrid community (document needed may be different for a different status or community):
...
* Pay the tax using the Modelo 790 (you can do it in most of the banks using the barcode - make you you keep the receipt)
...
You will need to take an apointment as otherwise they won't let you pass.
You can book it [**here**](https://sede.administracionespublicas.gob.es/pagina/index/directorio/icpplus)
Select the following options:
* Acceder al procedimiento
* Select Madrid as Provivincia and Aceptar
* Select Oficina: CNP Padre Piquer, Padre Piquer, 18, MADRID (it is the only place in Madrid community) and Tramites: POLICIA-CERTIFICADO DE REGISTRO DE CUIDADANO DE LA U.E. and Aceptar
* After that, you will need to authenticate yourself (it is not mandatory to have the digital certificate or Cl@ve) and it will give you free slots (usually for the following week)
